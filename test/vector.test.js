...
describe("sine and cosine of angle", () => {
  ...
  describe("45 degrees", () => {
    ...
    test("sine", () => {
      expect(sineOfAngle(shared, base, angle).toNumber()).toBeCloseTo(new BigNumber(2).sqrt().div(new BigNumber(2)).toNumber())
    })
    test("cosine", () => {
      expect(cosineOfAngle(shared, base, angle).toNumber()).toBeCloseTo(new BigNumber(2).sqrt().div(new BigNumber(2)).toNumber())
    })
  })
  ...
  describe("135 degrees", () => {
    ...
    test("cosine", () => {
      expect(cosineOfAngle(shared, base, angle).toNumber()).toBeCloseTo(new BigNumber(2).sqrt().negated().div(new BigNumber(2)).toNumber())
    })
  })
  ...
  describe("225 degrees", () => {
    ...
    const angle = { x: new BigNumber(-1), y: new BigNumber(1) }
    test("sine", () => {
      expect(sineOfAngle(shared, base, angle).toNumber()).toBeCloseTo(new BigNumber(2).sqrt().negated().div(new BigNumber(2)).toNumber())
    })
    test("cosine", () => {
      expect(cosineOfAngle(shared, base, angle).toNumber()).toBeCloseTo(new BigNumber(2).sqrt().negated().div(new BigNumber(2)).toNumber())
    })
